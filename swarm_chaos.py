...
def run_agent(name, config):
    ...
    try:
        ...
        print(color(f"  ⏱️  {name} took too long. Even agents need coffee breaks.", "r"))
        return False
    except FileNotFoundError:
        print(color(f"  ❌ {name} not found. The swarm mourns.", "r"))
        return False


def git_status_chaos():
    """Pull chaotic info from git."""
    print(color("\n  📊 SWARM INTEL (from git):", "c"))
    print(color("  " + "-" * 40, "c"))
...
def swarm_dashboard():
    ...
    print(color("\n  ┌─────────────────────────────────────────┐", "m"))
    print(color("  │       🐝 SWARM STATUS DASHBOARD 🐝       │", "m"))
    print(color("  └─────────────────────────────────────────┘", "m"))
    ...
    print(f"\n  🤖 Active agents in swarm: {color(str(agent_count), 'g')}")
    if KNOCKKNOCK_EXISTS:
        print(f"  🚪 KnockKnock Agent: {color('DETECTED', 'g')} (needs API key to run)")
    print(f"  📁 Repo: AlltheVibes-WildHackathon")
    print()
...
def chaos_engine():
    ...
    print()
    print(color("=" * 60, "m"))
    print(color("  🌀  S W A R M   C H A O S   E N G I N E  🌀", "m"))
    print(color("=" * 60, "m"))
    ...
    # Closing
    print(color("=" * 60, "m"))
    print(color("  🌀 CHAOS ENGINE COMPLETE. THE SWARM HAS SPOKEN. 🌀", "m"))
